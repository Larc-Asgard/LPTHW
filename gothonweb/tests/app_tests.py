...
def test_index():
    ...
    assert_response(resp, contains="Invalid")
    ...
    testdata = {'userinput': '2'}
    resp = client.post('/game', data=testdata)
    assert_response(resp, contains="Service Tunnel")

    testdata = {'userinput': '3'}
    resp = client.post('/game', data=testdata)
    assert_response(resp, contains="Escape Shuffle")

    testdata = {'userinput': '1'}
    resp = client.post('/game', data=testdata)
    assert_response(resp, contains="You Are Going Home")
